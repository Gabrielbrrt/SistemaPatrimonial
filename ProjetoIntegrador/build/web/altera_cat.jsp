<%-- 
    Document   : altera_cat
    Created on : 06/06/2021, 20:08:40
    Author     : Gabriel
--%>
    ...
    <body>
                ...
                <%
                    ...
                    if (request.getParameter("id") != null) {
                        ...
                        try {
                            ...
                            rs = st.executeQuery("SELECT * FROM tb_categoria WHERE id_categoria= '" + id + "' ");
                            while (rs.next()) {
                                id = rs.getString(1);
                                nome = rs.getString(2);
                            }
        ...
        <%
            if (request.getParameter("btnsalvar") != null) {
                ...
                try {
                    st = new Conexao().getConexao().createStatement();
                    st.executeUpdate("UPDATE tb_categoria SET desc_categoria='" + categoria + "' WHERE id_categoria= '" +idcat + "'");
                    response.sendRedirect("Categoria.jsp");
                } catch (Exception erro) {
                    throw new RuntimeException("erro AlterarCategoria" + erro);
                }
            }
        %>    
    </body>
